...
namespace SampleCsDockingDialog
{
  ...
  ///</summary>
  public class SampleCsDockingDialogPlugIn : RMA.Rhino.MRhinoUtilityPlugIn
  {
    RMA.UI.MRhinoUiDockBar _dockbar;
    SampleCsDockingDialogUserControl _control;
    ...
    {
      return new System.Guid("{6e255032-3356-4c9e-8509-2621fe3f6c7c}");
    }

    /// <returns>Plug-In name as displayed in the plug-in manager dialog</returns>
    public override string PlugInName()
    {
      return "SampleCsDockingDialog";
    }
